...
$(document).ready(function(){
	...
	$('#submit').on('click', function (e){
		...
		var v_fname = $('#inputFirstName').val();
		...
		console.log(firstName, lastName, email, addres)
		
		newlistItem = '<p> Hi ' + firstName + " "+ lastName + ' Thanks for using my web Form. We dont save your email we only show it to you as example ' + email + ' and your address ' + addres + ' Thanks for use my form</p>'
